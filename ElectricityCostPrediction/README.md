...
&nbsp;structure\_type\_industrial,

&nbsp;structure\_type\_mixed\_use,

&nbsp;structure\_type\_residential]
...
│   └── electricity\_cost\_model.ipynb
...
joblib.dump(model, "model\_name.pkl")
